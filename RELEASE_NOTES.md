...
- **버그·UX 수정 (Windows 인스톨러 재빌드, 2026-07-21)** — 위 .deb 재빌드 수정 4건 모두 포함, 추가로:
  ...
  - EEF XYZ 패널을 kinematics 설치 유무에 따라 활성/비활성 처리
...
- `.exe` SHA256: `32b02f2e4b31a6e602ac9bb88b7810c0c0811555b7514adc268b569118aab49f`
